            ...
            <div class="col-padded"><!-- inner custom column -->                
                <ul class="list-unstyled clear-margins"><!-- widgets -->                    
                    ...
                    <li class="widget-container widget_recent_news" id="cmsLoginContainer">
                        <form id="fellowCmsLogin" method="post" action="<?=BASE_URL?>data/verifyAndUpdateFellows" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-xs-offset-2 col-xs-8">
                                    <p>&nbsp;</p>
                                    <button type="submit" class="btn btn-primary naked text-blue">Update Fellow Details</button>
                                </div>
                            </div>
                        </form>
                    </li><!-- widgets list end -->
