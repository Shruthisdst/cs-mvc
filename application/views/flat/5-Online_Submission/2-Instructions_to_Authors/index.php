...
<p class="text-justify"><strong>Acknowledgements</strong> should be as brief as possible. <strong>Footnotes</strong> are not normally allowed except to identify the author for correspondence.</p>
<p class="text-justify"><strong>Cover photographs:</strong> Good colour photographs that pertain to a submitted paper will be considered for use on the cover. Good prints and a legend should be submitted with the manuscript.</p>
<p class="text-justify"><strong>Jurisdiction:</strong> The jurisdiction for all disputes concerning submitted articles, published material, advertisement, subscription and sale will be at courts/tribunals situated in Bangalore City only.</p>
