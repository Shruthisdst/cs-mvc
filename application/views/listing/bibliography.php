                    ...
                    <li class="widget-container widget_recent_news"><!-- widgets list -->               
                        ...
                        <ul class="list-unstyled">                          
                            <li class="journal-article">
                                <p class="journal-article-title"><?=$viewHelper->formatAuthor($data['author'], $data[0]->journal)?></p>
                                <p class="journal-article-subtitle">Articles written in <?=$viewHelper->journalFullNames{$data[0]->journal}?></p>
